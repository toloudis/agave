...
public:
  ...
  //--------------------------------------------------------------------
  // AddCallback by index, used by managed controls
  //--------------------------------------------------------------------
  void AddIntCallback(int i_CallbackIndex);

  //--------------------------------------------------------------------
  // RemoveCallback by index, used by managed controls
  //--------------------------------------------------------------------
  void RemoveIntCallback(int i_CallbackIndex);
  ...
  //--------------------------------------------------------------------
  void AddCallback(shared_ptr<prtyPropertyCallback> i_pCallback);
  ...
  //--------------------------------------------------------------------
  void RemoveCallback(shared_ptr<prtyPropertyCallback> i_pCallback);
  ...
  //--------------------------------------------------------------------
  virtual undoUndoOperation* CreateUndoOperation(shared_ptr<prtyPropertyReference> i_pPropertyRef) = 0;
...
private:
  ...
  std::list<int> m_CallbackIndices;
  std::vector<shared_ptr<prtyPropertyCallback>> m_CallbackObjects;
  bool m_bVisible;
