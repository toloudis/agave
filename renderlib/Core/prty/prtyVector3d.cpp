...
prtyVector3d::prtyVector3d()
  : prtyPropertyTemplate("Point3d", maVector3d(0, 0, 0))
  , m_bUseUnits(false)
{
}
...
prtyVector3d::prtyVector3d(const std::string& i_Name)
  : prtyPropertyTemplate(i_Name, maVector3d(0, 0, 0))
  , m_bUseUnits(false)
{
}
...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
prtyVector3d::prtyVector3d(const std::string& i_Name, const maVector3d& i_InitialValue)
...
{
  maVector3d newvec(i_ValueX, i_ValueY, i_ValueZ);
...
bool
prtyVector3d::operator==(const maVector3d& i_Value) const
{
...
void
prtyVector3d::SetScaledValue(const maVector3d& i_Value, bool i_bDirty) // UndoFlags i_Undoable)
{
  if (this->GetUseUnits())
