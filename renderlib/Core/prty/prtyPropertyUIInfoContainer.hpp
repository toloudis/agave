...
typedef std::list<shared_ptr<prtyPropertyUIInfo>> PropertyUIIList;
...
public:
  ...
  void Add(shared_ptr<prtyPropertyUIInfo>& i_pUIInfo);
  ...
  void Remove(shared_ptr<prtyPropertyUIInfo>& i_pUIInfo);
  ...
  //--------------------------------------------------------------------
  //--------------------------------------------------------------------
  const shared_ptr<prtyPropertyUIInfo> GetPropertyUIInfo(const std::string& i_Name);
  ...
  //------------------------------------------------------------------------
  void AddSubCategory(const std::string& i_CategoryName, const shared_ptr<prtyPropertyUIInfoContainer>& i_Properties);

  //------------------------------------------------------------------------
  // Remove subcategory
  //------------------------------------------------------------------------
  void RemoveSubCategory(const shared_ptr<prtyPropertyUIInfoContainer>& i_Properties);
...
private:
  ...
  {
    std::string m_Name;
    shared_ptr<prtyPropertyUIInfoContainer> m_Container;
  };
