...
struct property_match
{
  ...
  inline bool operator()(const shared_ptr<prtyPropertyUIInfo>& i_PUII)
  {
...
{
  inline bool operator()(shared_ptr<prtyPropertyUIInfo>& lhs, shared_ptr<prtyPropertyUIInfo>& rhs)
  {
...
//--------------------------------------------------------------------
void
prtyPropertyUIInfoContainer::Add(shared_ptr<prtyPropertyUIInfo>& i_pUIInfo)
{
...
prtyPropertyUIInfoContainer::Add(prtyPropertyUIInfo* i_pUIInfo)
{
  ...
  m_PropertyUIInfoList.push_back(shared_ptr<prtyPropertyUIInfo>(i_pUIInfo));
}
...
void
prtyPropertyUIInfoContainer::Remove(shared_ptr<prtyPropertyUIInfo>& i_pUIInfo)
{
...
//--------------------------------------------------------------------
//--------------------------------------------------------------------
const shared_ptr<prtyPropertyUIInfo>
prtyPropertyUIInfoContainer::GetPropertyUIInfo(const std::string& i_Name)
{
  ...
  return shared_ptr<prtyPropertyUIInfo>();
}
...
prtyPropertyUIInfoContainer::AddSubCategory(const std::string& i_CategoryName,
                                            const shared_ptr<prtyPropertyUIInfoContainer>& i_Properties)
{
...
//------------------------------------------------------------------------
void
prtyPropertyUIInfoContainer::RemoveSubCategory(const shared_ptr<prtyPropertyUIInfoContainer>& i_Properties)
{
