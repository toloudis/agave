...
public:
  ...
  //--------------------------------------------------------------------
  virtual bool CanReadBinaryData() const { return true; }
...
private:
  gfFileBin& m_File;
  envType::Int64 m_FileLength;
  std::stack<fsFileStream::FilePosType, std::vector<fsFileStream::FilePosType>> m_ChunkEnds;
};
